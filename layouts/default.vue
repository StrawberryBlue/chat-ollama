...
<!--&lt;!&ndash;        <span class="text-primary font-semibold text-lg">{{ $config.public.appName }}</span>&ndash;&gt;-->
<!--        <span class="text-primary font-semibold text-lg">逸青AI助手</span>-->
<!--      </h1>-->
...
<!--          <ColorMode />-->
<!--        </div>-->
<!--&lt;!&ndash;        <ULink to="https://github.com/sugarforever/chat-ollama"&ndash;&gt;-->
<!--&lt;!&ndash;               target="_blank"&ndash;&gt;-->
<!--&lt;!&ndash;               class="i-mdi-github text-2xl ml-2 mr-4"></ULink>&ndash;&gt;-->
<!--&lt;!&ndash;        <Auth />&ndash;&gt;-->
<!--      </div>-->
<!--      <div class="md:hidden">-->
